...
class ResNet(nn.Module):
    def __init__(self, block=BasicBlock, layers=[2, 2, 2, 2], sample_size=224, sample_duration=16, shortcut_type='A', num_classes=8, last_fc=True):
        ...
        self.units = nn.Parameter(torch.randn(8, 1))  
